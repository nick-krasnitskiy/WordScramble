...
struct ContentView: View {
    ...
    func addNewWord() {
        ...
        guard isStartOrShort(word: answer) else {
            wordError(title: "Word ia shorter than 3 letter or equal a start word", message: "Find another word!")
            return
        }
    ...
    func isStartOrShort(word: String) -> Bool {
